...
[![rules](https://img.shields.io/badge/rules-57%20built--in-blue.svg)](#built-in-rules)
...
Sentinel currently ships **57 built-in rules** (6 YAML + 51 Python plugins). Run `python -m sentinel list-rules` for the live count on your checkout.
